...
# Get only the cells that had a high prediction of cover type
...
ggplot(probabilityMapScenario4All) +
  ...
  theme(
    ...
    legend.key.size = unit(1, "cm"),  # Adjust size of squares
    legend.text = element_blank(),   # Ensure no labels
